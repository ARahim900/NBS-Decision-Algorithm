...
/* ─── SVG Icons ─── */
const AlertIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
);
const CheckCircle = () => (
  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 6 }}>
        ...
        <span style={{ fontSize: 20, fontWeight: 800, color, fontVariantNumeric: "tabular-nums" }}>{Math.round(pct)}%</span>
      </div>
...
export default function App() {
  ...
  // Slider fill percentage for track coloring
  const sliderPct = Math.round(((ageHrs - 1) / (72 - 1)) * 100);

  return (
    <div className="app-shell" style={{ fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif", background: "#0f172a", minHeight: "100dvh" }}>
      <div className="app-container">
        ...
        <div style={{ textAlign: "center", marginBottom: 28, paddingTop: 8 }}>
          ...
          <h1 style={{
            ...
            marginBottom: 6, letterSpacing: -0.5, lineHeight: 1.2,
          }}>
            NBS Decision Engine
          </h1>
          <p style={{ fontSize: 14, color: "#64748b", fontWeight: 500, lineHeight: 1.4 }}>
            ...
            <div className="card">
              ...
              <div style={{ marginBottom: 28 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 12 }}>
                  ...
                  <span style={{
                    fontSize: 30, fontWeight: 900, color: outcome.color,
                    fontVariantNumeric: "tabular-nums", lineHeight: 1, letterSpacing: -1,
                  }}>{ageHrs}<span style={{ fontSize: 16, fontWeight: 600, color: "#64748b", marginLeft: 3 }}>hrs</span></span>
                </div>
                <input
                  ...
                  style={{
                    width: "100%",
                    "--thumb-color": outcome.color,
                    "--track-fill": outcome.color,
                    "--track-pct": `${sliderPct}%`,
                  }}
                />
                <div style={{
                  display: "flex", justifyContent: "space-between",
                  fontSize: 11, color: "#64748b", marginTop: 10, fontWeight: 600,
                }}>
                  <span>1h</span>
                  <span style={{ color: "#ef4444" }}>12h</span>
                  <span style={{ color: "#f59e0b" }}>24h</span>
                  <span>48h</span>
                  <span>72h</span>
                </div>
              </div>
              ...
              {/* Can delay toggle */}
              <div style={{ marginBottom: 28 }}>
                <label style={{ fontSize: 14, fontWeight: 600, color: "#cbd5e1", display: "block", marginBottom: 12 }}>
                ...
                <div style={{ display: "flex", gap: 10 }}>
                  {[true, false].map(v => (
                    <button key={String(v)} onClick={() => setCanDelay(v)} style={{
                      ...
                      boxShadow: canDelay === v ? (v ? "0 4px 14px rgba(34,197,94,0.3)" : "0 4px 14px rgba(239,68,68,0.3)") : "none",
                    }}>
                ...
                <div className="wilayat-grid">
                  {Object.entries(wilayatMap).map(([k, v]) => (
                    <button key={k} onClick={() => setWilayat(k)} style={{
                      ...
                      boxShadow: wilayat === k ? "0 4px 14px rgba(59,130,246,0.3)" : "none",
                    }}>
                      {v.label}
                    </button>
                  ))}
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div>
                    <div style={{ fontWeight: 800, fontSize: 19, color: "#0f172a", letterSpacing: -0.3 }}>
                      Scenario {outcome.scenario}
                    </div>
                    <div style={{ fontSize: 13, color: "#475569", fontWeight: 600, lineHeight: 1.35, marginTop: 2 }}>
                      {outcome.title}
                    </div>
                  </div>
                </div>
              ...
              {/* Gauges */}
              <div className="gauges-grid" style={{
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    {outcome.referral.note && (
                      <div style={{ fontSize: 14, color: "#64748b", marginTop: 3 }}>{outcome.referral.note}</div>
                    )}
                    <div style={{
            ...
            <div className="transport-grid">
              {[
                ...
                <div key={i} style={{
                  ...
                  <div style={{ fontSize: 10, color: "#64748b", fontWeight: 700, marginBottom: 8, letterSpacing: 1.2 }}>
                    {item.label}
                  </div>
                  <div style={{ fontSize: 14, color: "#e2e8f0", lineHeight: 1.55, fontWeight: 500 }}>
                    {item.text}<strong style={{ color: item.hColor }}>{item.highlight}</strong>{item.rest}
                    {item.warning && (
                      <><br/><span style={{ color: "#ef4444", fontWeight: 700, fontSize: 12, marginTop: 4, display: "inline-block" }}>
                        {item.warning}
                      </span></>
                    )}
                  </div>
          ...
          <div className="card">
            ...
            <div>
              {[
                ...
                <div key={i} className="ce-row" style={{
                  borderBottom: i < arr.length - 1 ? "1px solid #334155" : "none",
                }}>
                  <span style={{ color: "#94a3b8", fontWeight: 500, flex: "1 1 42%", lineHeight: 1.45 }}>
                    {r.cause}
                  </span>
                  <span style={{ color: r.c, flexShrink: 0, display: "flex" }}>
                    <ArrowRight />
                  </span>
                  <span style={{ color: r.c, fontWeight: 600, flex: "1 1 52%", lineHeight: 1.45 }}>
                    {r.effect}
                  </span>
                </div>
              ))}
        ...
        <div style={{
          ...
          marginTop: 32, lineHeight: 1.6, fontWeight: 500,
          paddingBottom: 8,
        }}>
